...
import com.test_27thoct_mobile.test_27thoct.*;


/**
 * ServiceImpl object for domain model class Table1.
 * @see com.test_27thoct_mobile.test_27thoct.Table1
 */
@Service("test_27thoct.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("test_27thoct.Table1Dao")
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "test_27thoctTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "test_27thoctTransactionManager")
    @Override
